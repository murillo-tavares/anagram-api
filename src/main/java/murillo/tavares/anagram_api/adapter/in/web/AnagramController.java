...
public class AnagramController {
	...
	public AnagramResponse submitAnswer(@Valid @RequestBody SubmitAnagramAnswerRequest request) {
		DailyAnagram dailyAnagram = submitDailyAnagramAnswerUseCase.submitAnswer(request.answer());
		return anagramWebMapper.toResponse(dailyAnagram);
	}
}
